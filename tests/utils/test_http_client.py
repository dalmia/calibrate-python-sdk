...
from calibrate.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    _should_retry,
...
from calibrate.core.request_options import RequestOptions
...
@patch("calibrate.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("calibrate.core.http_client.asyncio.sleep", new_callable=AsyncMock)
